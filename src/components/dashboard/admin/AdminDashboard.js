  ...
  return (
    <div className="flex h-screen bg-gray-100 overflow-hidden text-black">
      ...
      <div className="flex-1 flex flex-col overflow-hidden text-black">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 p-4 flex min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 text-black">
