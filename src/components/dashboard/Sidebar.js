...
const Sidebar = () => {
  ...
  return (
    <div
      className={`flex flex-col transition-all ease-out duration-200 w-64 border-r-[1px] border-richblack-700 bg-blue-rgb(8, 143, 143) h-full py-10
          fixed z-[5000] ${clicked ? "left-0" : "left-[-222px]"} md:relative md:left-0`}
    >
      <p
